...
AppRouterModule = __decorate([
    core_1.NgModule({
        imports: [router_1.RouterModule.forRoot(routes, { useHash: app_configuration_1.AppConfiguration.useHashStrategy })],
        exports: [router_1.RouterModule],
        providers: [app_configuration_1.AppConfiguration.useCaseSensitiveUrl ? [] : {
