...
module.exports = merge(pkgsLoader, {
    ...
    resolve: {
        // tells webpack to automatically resolve extensions
    ...
    module: {
        rules: [
            ...
            // Refer: https://stackoverflow.com/questions/37671342/how-to-load-image-files-with-webpack-file-loader
